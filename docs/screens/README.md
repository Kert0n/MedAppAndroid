...
рюкзак), коробки во всех состояниях сразу — просроченная, истекающая, на лечении, в пути, с чужими
...
| `16-course-sources` | `stack`, `unsaved-edit` | источники: обеспечение «Записано» первым, коробка карточкой; незаписанная правка — строка «С правкой» |
| `17-source-picking` | `cards` | выбор коробки: подходящие и неподходящие с причиной |
| `18-intake-card` | `planned` | карточка пункта плана |
| `19-intake-history` | `of-package`, `of-course` | история приёмов коробки и лечения |
...
| `26-reports` | `summary`, `future`, `spent`, `spent-custom` | отчёты: сводка полосами; расход до даты; истрачено за месяц; свой период |
