 ...
 *
 * Поднимает поля **только форма**: окно объявляет `adjustResize` и отдаёт ей высоту клавиатуры
 * insets'ами (`AndroidManifest`, `WindowDeclarationTest`). Иначе система поднимает и окно тоже, и
 * подъёма выходит два.
 *
