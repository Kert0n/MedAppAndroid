 ...
 * reservedByOthers — сколько из неё заявлено не мной: экран называет это числом и словами, а не
 * одной разницей между двумя другими числами, которую человек считал бы в уме.
 *
