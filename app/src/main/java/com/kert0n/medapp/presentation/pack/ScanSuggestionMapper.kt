 ...
 *
 * **Слово единицы обязательно.** Голое «20» количеством не считается: двадцать чего — реестр не
 * сказал, а в описании эта строка тогда и не окажется, потому что уйдёт в поле. Пусть лучше
 * человек прочитает «20» в описании и впишет сам (разбор #55).
 *
...
/** Число и **одно слово** за ним: «30 шт», «100 мл», «20 таблеток». */
