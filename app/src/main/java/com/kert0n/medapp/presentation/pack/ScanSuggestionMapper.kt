 ...
 *
 * **Берётся всё, что реестр сказал.** У ответа девять сведений, и у каждого своё место: название,
 * форма, производитель, страна и срок ложатся в свои поля; количество — в своё, когда его можно
 * прочитать числом; остальное — в описание, теми же словами, какими его назвал реестр. Оставить
 * сказанное за бортом значит заставить человека переписывать с коробки то, что приложение уже
 * прочитало.
 *
 ...
 * разовой дозой не становится никогда (PLAN H5).
 */
