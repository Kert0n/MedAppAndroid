 ...
 *
 * Названный день, совпавший с последним днём месяца, вернётся месяцем: в домене это **одно и то
 * же значение** (`ExpiryDate.of(YearMonth)` — PLAN C1), и различить «31.03.2027» и «03.2027»
 * здесь нечем. Срок от этого не меняется, меняется написание.
 */
