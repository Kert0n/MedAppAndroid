 ...
 * реестра маркировки: EAN-13 описывает товар, а не эту коробку, QR — приглашение в полку и идёт
...
class PackageScanning @Inject constructor(
    ...
    sealed interface Outcome {
        ...
        /** Не DataMatrix реестра маркировки: спрашивать не о чем, и запроса не было. */
