...
class CourseCalendar @Inject constructor(
     ...
     * ни другое ничего не меняет. Достройка может завести пункты уже прошедших дней (приложение не
     * открывали несколько дней, окно давно не достраивали), а их отметка сдвигает конец и требует ещё одного
