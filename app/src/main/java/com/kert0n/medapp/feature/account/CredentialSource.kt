...
/**
 * Что сценарию регистрации нужно от хранилища учётки: прочитать её, записать придуманную и
 * отметить, что сервер её принял. Хранит её платформа, а сеть читает через этот же порт учётку для
 * пропуска — о хранилище не знает ни тот, ни другая.
 */
