 ...
 *
 * Состояния заводятся **переходами самой строки** (`settle`), как их завело бы хранение: своей
 * SQL-двери у проверки нет, и состояний, которых приложение не выражает, она поставить не может.
 */
@HiltAndroidTest
