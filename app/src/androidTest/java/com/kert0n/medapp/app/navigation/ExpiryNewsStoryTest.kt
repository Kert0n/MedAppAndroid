...
/**
 * **Истории Нины** — «последний день у двух коробок» и «не открыла в тот день»
 * (`docs/истории.md`, U5).
 *
 * Рассказы — там; здесь её путь по приложению и то, что стережёт каждый шаг. Срок годности
 * наступает раз в жизни коробки: подгадать этот день человеку нечем, а в проверке он назначается
 * строкой.
 */
@HiltAndroidTest
