...
class HundredMedKitsTest {
    ...
    fun theContentsScreenAndTheCardOpenWithinTheBenchmark(): Unit = runBlocking {
        ...
        val card = PackageCardViewModel(scenarios.packageRemoval, com.kert0n.medapp.fixture.offlineFreshening(), database.packageRepository(), database.medKitRepository(), database.courseRepository(), database.queueRepository(), today, seed.packages.first())
