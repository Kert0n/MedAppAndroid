...
class CourseCalendarTest {
     ...
     * (PLAN D5). Лечение начато 8-го, а приложение до 10-го не открывали, и один проход доводит
     * календарь до конца: пункты прошедших дней сразу пропуски, а замена им уже впереди.
     */
    @Test
