...
class Scenarios(
    ...
    val reminderAnswering = com.kert0n.medapp.feature.notification.ReminderAnswering(
        intakeDeclining, intakeConfirmation, database.intakeRepository(), reminderPromising, reminderStore, reminderWithdrawal, notificationSettings, transactions, clock
    )
    /**
